            ...
            <div className="flex h-16 items-center justify-between px-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="relative p-2 hover:bg-gray-100 rounded-lg transition group">
                        ...
                        <Badge className="absolute -top-0.5 -right-0.5 h-4 min-w-4 px-1 text-[10px] bg-red-500 text-white border-2 border-white hover:bg-red-500 rounded-full flex items-center justify-center">
                            3
                        </Badge>
                    </button>
