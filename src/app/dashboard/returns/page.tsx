...
import { Search, Plus, Edit2, Trash2, Download, RefreshCw, DollarSign } from 'lucide-react';
import { returnsService } from '@/modules/orders/services/returns.service';
...
export default function ReturnsPage() {
    ...
    const handleProcessRefund = async (returnItem: Return) => {
        if (!confirm(`Process refund of ₹${returnItem.refund_amount?.toFixed(2)} for Order #${returnItem.order_id}?`)) return;
