...
import { AddQueryDialog } from '@/modules/queries/components/add-query-dialog';
import { CustomerDetailsDialog } from '@/modules/queries/components/customer-details-dialog';
import { EscalateDialog } from '@/modules/queries/components/escalate-dialog';
import { ConversationDialog } from '@/modules/queries/components/conversation-dialog';
...
export default function QueriesPage() {
    ...
    const getSourceIcon = (source: string) => {
        ...
        if (normalizedSource === 'whatsapp' || normalizedSource === 'web' || normalizedSource === 'website') {
                                        ...
                                        <tr key={query.query_id} className="border-b hover:bg-gray-50">
                                            ...
                                            <td className="p-3">
                                                <div className="flex items-center gap-2">
                                                    {getSourceIcon(query.source || query.customers?.source || 'WhatsApp')}
                                                    <span className="text-xs text-gray-600">{query.source || query.customers?.source || 'WhatsApp'}</span>
                                                </div>
                                            </td>
                                            <td className="p-3">
                                                <div>
