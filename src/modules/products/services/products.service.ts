...
export const productsService = {
     ...
     */    async fetchProductsViaEdgeFunction(page: number = 1, limit: number = 50, search?: string): Promise<{ data: Product[]; total: number; }> {
        try {
    ...
    async fetchProductStats(): Promise<{
        ...
        try {
            ...
            const response = await fetch(
                `${getSupabaseBaseUrl()}/functions/v1/product-stats`,
                {
                    headers: {
