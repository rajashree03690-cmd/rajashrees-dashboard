...
export async function fetchCombos(
    ...
    try {
        ...
        const response = await fetch(
            `${getSupabaseBaseUrl()}/functions/v1/getCombo?${queryString}`,
            {
                headers: {
...
export async function addCombo(combo: Partial<Combo>): Promise<boolean> {
    try {
        const response = await fetch(
            `${getSupabaseBaseUrl()}/functions/v1/create-combo-with-items`,
            {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${getSupabaseAnonKey()}`,
...
export async function updateCombo(combo: Combo): Promise<boolean> {
    try {
        const response = await fetch(
            `${getSupabaseBaseUrl()}/functions/v1/insert-item-in-combo`,
            {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${getSupabaseAnonKey()}`,
