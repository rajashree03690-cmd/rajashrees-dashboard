-- =============================================
-- SAFE ADDITIVE MIGRATION v2: Handles Existing Data
-- =============================================

-- =============================================
-- 1. ADD MISSING INDEXES (Safe - no data changes)
-- =============================================
...
-- =============================================
-- 3. AUTH TRIGGER: Sync auth.users → customers
-- =============================================
...
CREATE POLICY "Users can view their own order items"
    ...
    USING (
        order_id IN (
            ...
            JOIN public.customers c ON o.customer_id::bigint = c.customer_id
...
-- =============================================
-- MIGRATION COMPLETE
-- Safe for existing data - no constraints added
-- =============================================
