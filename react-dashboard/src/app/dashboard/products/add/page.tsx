...
export default function AddProductPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Validate duplicate SKU and product name
        console.log('🔍 Validating SKU and product name...');
        const validation = await productsApiService.validateProduct(sku, productName);
